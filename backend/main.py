...
async def update_client(client_id: str, data: dict, user: dict = Depends(require_auth)):
    ...
    # 更新字段
    allowed_fields = ["name", "industry", "initial_demand", "status", "step1_result", "step2_report", "step2_todo", "step2_schema", "demo_url", "_wecom_docid", "_wecom_url", "_step1_wecom_docid", "_step1_wecom_url"]
    updates = []
    values = []
    for field in allowed_fields:
        if field in data:
            ...
            if field in ("step1_result", "step2_report", "step2_todo", "step2_schema"):
